...
import com.efunhub.groceryshop.activities.WalletActivity;
...
public class WalletAdapter  extends RecyclerView.Adapter<WalletAdapter.MyViewHolder> {
    ...
    public WalletAdapter(Context applicationContext, List<ModelCategories> modelCategoriesList) {

        this.modelCategoriesList = modelCategoriesList;
        this.context = applicationContext;
    }

    public WalletAdapter(WalletActivity applicationContext, List<WalletModel> walletlist) {
    }
    ...
    public WalletAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == ROW_ITEM) {
            ...
            return new WalletAdapter.MyViewHolder(rootview);
        } else {
